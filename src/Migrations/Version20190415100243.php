 ...
 */
final class Version20190415100243 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE assignment (id INT AUTO_INCREMENT NOT NULL, groupe_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_30C544BA7A45358C (groupe_id), INDEX IDX_30C544BAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE assignment ADD CONSTRAINT FK_30C544BA7A45358C FOREIGN KEY (groupe_id) REFERENCES `group` (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE assignment DROP FOREIGN KEY FK_30C544BA7A45358C');
